...
public class CommandMain {
    ...
    public static void main(String[] args) {
        ...
        // TurnTVOn contains the behavioral.command to turn on the tv
        // When execute() is called on this behavioral.command object
        ...
        /*
         * It is common to be able to undo a behavioral.command in a behavioral.command pattern
